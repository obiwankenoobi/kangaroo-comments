            ...
            <div>
                {
                    ...
                    <MaterialBtn color='primary' onClick={() => this.isEnoughChars(this.state.replyMsg,  () => this.sendCommend(this.props.commentId, this.state.replyMsg)) } className='sendBtn'>send</MaterialBtn>
                    :
                    <NameLogin/>
                }
            </div> 
             ...
             className='msg-container'>
           ...
           
                {
                    this.state.openReply ? 
                        <div >
                            <TextArea style={{ ...textBoxErrorCSS , minHeight: 100 }} value={this.state.replyMsg} type='text' onChange={(e) => this.handleInput(e)} name='replyMsg' className='replyMsg'/>
